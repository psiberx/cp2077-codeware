...
// Generated by cp77ida.py on 2023-11-04 for Cyberpunk 2077 v.2.02
...
constexpr uintptr_t PointOfInterestMappin_SetPhase = 0x1426E5870 - ImageBase; // 48 89 5C 24 ? 48 89 74 24 ? 48 89 7C 24 ? 55 41 56 41 57 48 8B EC 48 83 EC ? 48 8B D9 44 8B F2, expected: 1, index: 0
