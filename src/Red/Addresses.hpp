...
// Generated by cp77ida.py on 2023-04-11 for Cyberpunk 2077 v.1.61
...
constexpr uintptr_t CGameFramework_InitializeGameInstance = 0x142A2C2D0 - ImageBase; // 48 89 5C 24 10 57 48 83 EC 20 48 8B F9 48 8B DA 0F B6 4A 32 E8 ? ? ? ? 0F B6 47 08 48 8D 54 24 30, expected: 1, index: 0
...
constexpr uintptr_t ScriptBundle_dtor = 0x140274380 - ImageBase; // 48 89 5C 24 08 48 89 74 24 10 57 48 83 EC 20 48 8B D9 E8 ? ? ? ? 48 8D 8B 38 01 00 00, expected: 1, index: 0
