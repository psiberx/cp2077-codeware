        ...
        Output(filename="src/Red/Addresses.hpp", namespace="Red::Addresses", groups=[
            ...
            Group(name="CGameFramework", functions=[
                Item(name="InitializeGameInstance",
                     pattern="48 89 5C 24 10 57 48 83 EC 20 48 8B F9 48 8B DA 0F B6 4A 32 E8 ? ? ? ? 0F B6 47 08 48 8D 54 24 30"),
            ]),
            Group(name="Entity", functions=[
                Item(name="Attach",
                     pattern="48 89 5C 24 08 48 89 74 24 10 48 89 7C 24 18 4C 89 64 24 20 55 41 56 41 57 48 8B EC 48 81 EC 80 00 00 00 C6 81 56 01 00 00 03 4C 8B FA 80 7A 18 00"),
                Item(name="Detach",
                     pattern="48 89 5C 24 10 48 89 74 24 18 57 48 83 EC 40 48 8B 81 B8 00 00 00 48 8B F1 C6 81 56 01 00 00 05"),
                Item(name="Dispose",
                     pattern="40 56 48 83 EC 60 0F B6 81 56 01 00 00 48 8B F1 2C 02 3C 03 0F 87 ? ? ? ? 48 8B 89 B8 00 00 00"),
                ...
                Item(name="Uninitialize",
                     pattern="48 89 5C 24 18 55 56 57 48 83 EC 50 48 8B F1 C6 81 56 01 00 00 06 48 81 C1 D8 00 00 00 E8"),
            ]),
